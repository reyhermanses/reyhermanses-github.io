...
const CAutocompleter: React.FC<AutocompleterProps> = ({ withSearch, suggestions, backgroundColor, multipleSelection }) => {
                    ...
                    <div onClick={fnOnSearch} style={{ backgroundColor: backgroundColor ? '#5c4033' : '#fff' }} className="border border-gray-300 rounded-md p-2 flex items-center justify-between">
                        <div className="cursor-pointer flex items-center">
                            {selectedSuggestions.map(suggestion => (
                                <div
                                    key={suggestion}
                                    className="inline-flex items-center bg-red-500 text-white text-sm px-3 py-1 rounded-full"
                                >
                                    {suggestion}
                                    <svg
                        ...
                        <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                            ...
                            >
                                <path
                                    ...
                                    strokeLinejoin="round"
                                    strokeWidth="2"
                                    d="M21 21l-4.99-4.99m-.02-4.99a7.5 7.5 0 11-13.47-4.76 7.5 7.5 0 018.91 8.91 7.5 7.5 0 014.75 13.47zM15 15l6 6"
                                />
                            </svg>
                        </span>
                    </div>
